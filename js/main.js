...
//---Paso 1: Tener el array con los datos---
...
//---Este elemento es donde se van a acomodar las cards---
const cardsContainer = document.getElementById("cartas");

//---Paso 2: Se hace un for para los elementos del array---
...
//---FUNCION getProducto EJEMPLO DE CLASE NO APLICA EN EL  EJERCICIO---
//producto = null;    //---Para probar error, por eso se comentó---

//---Se sustituye esta función con la de más abajo para hacer un request---
...
function getProducto(){     //---Con Fetch---
    ...
    promesa.then( (response) => {
        ...
        .catch( (err) => {
            console.error("Error en el formato de la serspuesta: " + err.message);
        })
    } // response
    ) // then
    .catch((error) => {
...
// getProducto()
//             .then( (prod)=> console.log(prod) )   //---se ejecuta si es resolve---
//             .catch( (err)=> console.log(err.message) );   //---se ejecuta si es reject---